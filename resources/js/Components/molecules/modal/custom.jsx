...
const Custom = ({
  ...
  const confirmHandler = async () => {
    const { onSuccess, onFailed, onClick = () => true } = buttonConfirm;
    try {
      const passed = await onClick();
      if (passed) {
  ...
  return (
    <>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal} onClick={openModal}>
          <Transition.Child
            as={Fragment}
